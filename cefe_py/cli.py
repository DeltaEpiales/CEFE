...
def main():
    parser = argparse.ArgumentParser(description="CEFE Quantum & Field Simulator CLI")
    parser.add_argument("--mode", type=str, choices=['qm', 'heg', 'qft'], default='qm', help="Engine simulation mode (qm, qft, or heg)")
